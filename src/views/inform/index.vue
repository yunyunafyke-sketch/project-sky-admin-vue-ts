...
export default class extends Vue {
  ...
  // activeIndex/status 控制当前查看未读还是已读消息。
  ...
  get ountUnread() {
    // 未读数量存在 Vuex app 模块里，顶部栏也会读取同一个值。
